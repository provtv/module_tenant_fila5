---
title: "On-Demand Pattern — Module Tenant"
type: documentation
created: 2026-05-11
updated: 2026-05-11
...
# On-Demand Pattern — Module **Tenant**
...
| Ricerca locale | `qmd search "topic" -c tenant` |
| Wiki locale | `Read ./laravel/Modules/Tenant/docs/wiki/index.md` |
...
3. **Mantieni la wiki aggiornata** — Dopo ogni task, aggiorna ./laravel/Modules/Tenant/docs/wiki/log.md
