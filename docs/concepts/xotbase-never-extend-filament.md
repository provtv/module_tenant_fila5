...
type: concept
module: Tenant
tags: [tenant, filament, xotbase, architecture]
created: 2026-07-16
updated: 2026-07-16
qmd: "Tenant filament never extend Filament class XotBase mirror path"
related:
...
Nessuna classe in `Modules/Tenant` estende una classe `Filament\...` direttamente.
